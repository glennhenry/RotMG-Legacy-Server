package com.junkbyte.console.core
{
   ...
   public class CommandLine extends ConsoleCore
   {
      ...
      public function set base(param1:Object) : void
      {
         ...
         this._saved._SafeStr_0("base",param1);
      }
      
      public function get base() : Object
      {
         return this._saved._SafeStr_1("base");
      }
      ...
      public function store(param1:String, param2:Object, param3:Boolean = false) : void
      {
         ...
         this._saved._SafeStr_0(param1,param2,param3);
      }
      ...
      public function getHintsFor(param1:String, param2:uint) : Array
      {
         ...
         if(config.commandLineAllowed)
         {
            ...
            {
               all.push(["$" + Y,LogReferences.ShortClassName(this._saved._SafeStr_1(Y))]);
            }
            if(this._scope)
            {
      ...
      private function execCommand(param1:String) : void
      {
         ...
         if(cmd == "")
         {
            this.setReturned(this._saved._SafeStr_1(Executer.RETURNED),true);
            return;
         }
      ...
      public function setReturned(param1:*, param2:Boolean = false, param3:Boolean = true) : void
      {
         ...
         if(param1 !== undefined)
         {
            this._saved._SafeStr_0(Executer.RETURNED,param1,true);
 ...
 * @identifier _SafeStr_1 = "get"
 * @identifier _SafeStr_0 = "set"
 */
