package com.google.analytics.v4
{
   ...
   public class Tracker implements GoogleAnalyticsAPI
   {
      ...
      public function setCampNameKey(param1:String) : void
      {
         ...
         var _loc2_:String = "setCampNameKey( " + _config.campaignKey.UCCN + " )";
      ...
      public function setCampContentKey(param1:String) : void
      {
         ...
         var _loc2_:String = "setCampContentKey( " + _config.campaignKey.UCCT + " )";
         if(_debug.mode == VisualDebugMode.geek)
         {
      ...
      public function setCampSourceKey(param1:String) : void
      {
         ...
         var _loc2_:String = "setCampSourceKey( " + _config.campaignKey.UCSR + " )";
         if(_debug.mode == VisualDebugMode.geek)
         {
      ...
      private function _isNotGoogleSearch() : Boolean
      {
         ...
         var _loc2_:Boolean = _loc1_.indexOf("www.google.") < 0;
         var _loc3_:Boolean = _loc1_.indexOf(".google.") < 0;
         var _loc4_:Boolean = _loc1_.indexOf("google.") < 0;
         var _loc5_:Boolean = _loc1_.indexOf("google.org") > -1;
      ...
      public function setCampNOKey(param1:String) : void
      {
         ...
         var _loc2_:String = "setCampNOKey( " + _config.campaignKey.UCNO + " )";
         if(_debug.mode == VisualDebugMode.geek)
         {
      ...
      public function setCampTermKey(param1:String) : void
      {
         ...
         var _loc2_:String = "setCampTermKey( " + _config.campaignKey.UCTR + " )";
         if(_debug.mode == VisualDebugMode.geek)
         {
      ...
      public function setCampMediumKey(param1:String) : void
      {
         ...
         var _loc2_:String = "setCampMediumKey( " + _config.campaignKey.UCMD + " )";
         if(_debug.mode == VisualDebugMode.geek)
         {
