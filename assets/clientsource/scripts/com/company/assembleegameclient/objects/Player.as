package com.company.assembleegameclient.objects
{
   ...
   public class Player extends Character
   {
      ...
      {
         var _loc3_:com.company.assembleegameclient.map.Square = map_.lookupSquare(param1,param2);
      ...
      override public function update(param1:int, param2:int) : Boolean
      {
         ...
         if(this.relMoveVec_ != null)
         {
            _loc3_ = Number(Parameters.data_.cameraAngle);
            if(this.rotate_ != 0)
            {
         ...
         {
            _loc8_ = int(map_.gs_.gsc_.getNextDamage(square_.props_.minDamage_,square_.props_.maxDamage_));
      ...
      public function onMove() : void
      {
         ...
         var _loc1_:com.company.assembleegameclient.map.Square = map_.getSquare(x_,y_);
      ...
      protected function drawBreathBar(param1:Vector.<IGraphicsData>, param2:int) : void
      {
         ...
         _loc6_.length = 0;
         _loc6_.push(posS_[0] - _loc3_,posS_[1] + 8,posS_[0] + _loc3_,posS_[1] + 8,posS_[0] + _loc3_,posS_[1] + 8 + 6,posS_[0] - _loc3_,posS_[1] + 8 + 6);
         ...
         if(this.breath_ > 0)
         {
            ...
            _loc6_.length = 0;
            _loc6_.push(posS_[0] - _loc3_,posS_[1] + 8,posS_[0] - _loc3_ + _loc8_,posS_[1] + 8,posS_[0] - _loc3_ + _loc8_,posS_[1] + 8 + 6,posS_[0] - _loc3_,posS_[1] + 8 + 6);
      ...
      private function getMoveSpeed() : Number
      {
         ...
         return _loc1_ * this.moveMultiplier_;
      }
      ...
      override protected function getTexture(param1:Camera, param2:int) : BitmapData
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = GlowRedrawer.outlineGlow(_loc8_,this.legendaryRank_ == -1 ? 0 : 16711680);
      ...
      private function doShoot(param1:int, param2:int, param3:XML, param4:Number, param5:Boolean) : void
      {
         ...
         while(_loc10_ < _loc6_)
         {
            ...
            _loc15_ = param5 ? this.attackMultiplier() : 1;
      ...
      {
         var _loc1_:int = int(equipment_.length);
         var _loc2_:uint = 4;
         while(_loc2_ < _loc1_)
         {
