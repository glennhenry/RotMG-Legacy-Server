   ...
   public class CharacterBox extends Sprite
   {
      ...
      public function unlock() : void
      {
         ...
         if(this.available_ == false)
         {
            ...
            if(Boolean(this.lock_) && contains(this.lock_))
            {
               removeChild(this.lock_);
            }
            if(Boolean(this.saleTag_) && contains(this.saleTag_))
            {
               removeChild(this.saleTag_);
            }
            if(Boolean(this.saleText_) && contains(this.saleText_))
            {
      ...
      private function setBuyButton() : void
      {
         ...
         this.buyButton_.y += this.graphic_.height;
