package com.company.assembleegameclient.ui.options
{
   ...
   public class Options extends Sprite
   {
      ...
      public function Options(param1:GameSprite)
      {
         ...
         var _loc3_:int = 0;
         var _loc5_:OptionsTabTitle = null;
         ...
         {
            _loc5_ = new OptionsTabTitle(TABS[_loc4_]);
            _loc5_.x = _loc3_;
            _loc5_.y = 70;
            addChild(_loc5_);
            _loc5_.addEventListener(MouseEvent.CLICK,this.onTabClick);
            this.tabs_.push(_loc5_);
            _loc3_ += 108;
            _loc4_++;
         }
      ...
      private function onAllChatDisabled() : void
      {
         ...
         var _loc1_:int = 0;
         for(; _loc1_ < this.options_.length; _loc1_++)
         {
      ...
      private function onPlaySoundEffectsChange() : void
      {
         ...
         if(Boolean(Parameters.data_.playSFX) || Boolean(Parameters.data_.playPewPew))
         {
            SFX.setSFXVolume(1);
         }
         else
