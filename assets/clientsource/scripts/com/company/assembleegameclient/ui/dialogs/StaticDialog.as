package com.company.assembleegameclient.ui.dialogs
{
   ...
   public class StaticDialog extends Sprite
   {
      ...
      private var replaceTokens:Object = this.replaceTokens;
      ...
      {
         if(Boolean(this.leftButton) && this.box_.contains(this.leftButton))
         {
            this.box_.removeChild(this.leftButton);
         }
         if(Boolean(this.rightButton) && this.box_.contains(this.rightButton))
         {
