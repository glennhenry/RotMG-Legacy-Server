package com.company.assembleegameclient.game
{
   ...
   public class GameSprite extends AGameSprite
   {
      ...
      override public function initialize() : void
      {
         ...
         else if(map.name_ != "Arena" && map.name_ != "Kitchen" && map.name_ != "Nexus Explanation" && map.name_ != "Vault Explanation" && map.name_ != "Guild Explanation" && !this.evalIsNotInCombatMapArea() && Boolean(Parameters.data_.showProtips))
         {
      ...
      private function updateNearestInteractive() : void
      {
         ...
         for each(_loc7_ in map.goDict_)
         {
            ...
            if((Boolean(_loc8_)) && (!(_loc8_ is Pet) || this.map.isPetYard))
            {
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         if(this.focus)
         {
            camera_.configureCamera(this.focus,_loc5_ ? _loc5_.isHallucinating() : false);
