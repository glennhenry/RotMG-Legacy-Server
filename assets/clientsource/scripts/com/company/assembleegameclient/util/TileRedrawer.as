package com.company.assembleegameclient.util
{
   ...
   public class TileRedrawer
   {
      ...
      public static function redraw(param1:com.company.assembleegameclient.map.Square, param2:Boolean) : BitmapData
      {
      ...
      private static function getSig(param1:com.company.assembleegameclient.map.Square) : ByteArray
      {
         var _loc6_:int = 0;
         var _loc7_:com.company.assembleegameclient.map.Square = null;
      ...
      private static function getCompositeSig(param1:com.company.assembleegameclient.map.Square) : ByteArray
      {
         var _loc14_:com.company.assembleegameclient.map.Square = null;
         var _loc15_:com.company.assembleegameclient.map.Square = null;
         var _loc16_:com.company.assembleegameclient.map.Square = null;
         ...
         var _loc6_:com.company.assembleegameclient.map.Square = _loc3_.lookupSquare(_loc4_,_loc5_ - 1);
         var _loc7_:com.company.assembleegameclient.map.Square = _loc3_.lookupSquare(_loc4_ - 1,_loc5_);
         var _loc8_:com.company.assembleegameclient.map.Square = _loc3_.lookupSquare(_loc4_ + 1,_loc5_);
         var _loc9_:com.company.assembleegameclient.map.Square = _loc3_.lookupSquare(_loc4_,_loc5_ + 1);
         var _loc10_:int = _loc6_ != null ? _loc6_.props_.compositePriority_ : -1;
         var _loc11_:int = _loc7_ != null ? _loc7_.props_.compositePriority_ : -1;
         var _loc12_:int = _loc8_ != null ? _loc8_.props_.compositePriority_ : -1;
         var _loc13_:int = _loc9_ != null ? _loc9_.props_.compositePriority_ : -1;
      ...
      private static function getEdgeSig(param1:com.company.assembleegameclient.map.Square) : ByteArray
      {
         var _loc7_:int = 0;
