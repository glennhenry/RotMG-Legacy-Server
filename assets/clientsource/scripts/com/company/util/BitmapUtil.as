   ...
   public class BitmapUtil
   {
      ...
      public static function amountTransparent(param1:BitmapData) : Number
      {
         ...
         while(_loc3_ < param1.width)
         {
            ...
            {
               _loc5_ = param1.getPixel32(_loc3_,_loc4_) & 0xFF000000;
               if(_loc5_ == 0)
               {
                  _loc2_++;
               }
      ...
      public static function lineOfSight(param1:BitmapData, param2:IntPoint, param3:IntPoint) : Boolean
      {
         ...
         var _loc10_:Boolean = (_loc7_ > _loc9_ ? _loc7_ - _loc9_ : _loc9_ - _loc7_) > (_loc6_ > _loc8_ ? _loc6_ - _loc8_ : _loc8_ - _loc6_);
         if(_loc10_)
         {
            _loc11_ = _loc6_;
            _loc6_ = _loc7_;
         ...
         var _loc16_:int = _loc8_ > _loc4_ - 1 ? int(_loc4_ - 1) : _loc8_;
         var _loc17_:int = _loc7_;
         var _loc18_:int = _loc6_;
         if(_loc18_ < 0)
         {
            _loc14_ += _loc13_ * -_loc18_;
            if(_loc14_ >= 0)
            {
               _loc19_ = _loc14_ / _loc12_ + 1;
               _loc17_ += _loc15_ * _loc19_;
         ...
         if(_loc15_ > 0 && _loc17_ < 0 || _loc15_ < 0 && _loc17_ >= _loc5_)
         {
            ...
            _loc14_ -= _loc12_ * _loc20_;
            _loc21_ = -_loc14_ / _loc13_;
            _loc18_ += _loc21_;
            _loc14_ += _loc21_ * _loc13_;
            _loc17_ += _loc20_ * _loc15_;
         }
