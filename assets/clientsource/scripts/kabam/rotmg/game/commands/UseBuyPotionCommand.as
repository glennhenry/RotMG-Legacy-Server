package kabam.rotmg.game.commands
{
   ...
   public class UseBuyPotionCommand
   {
      ...
      {
         var _loc1_:Boolean = this.player.credits_ >= this.potion.currentCost(this.player.getPotionCount(this.potionId));
         var _loc2_:Boolean = Boolean(Parameters.data_.contextualPotionBuy);
      ...
      private function sendServerRequest() : void
      {
         ...
         var _loc2_:int = int(Parameters.data_.contextualPotionBuy);
